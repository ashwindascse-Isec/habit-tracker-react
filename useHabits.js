...
export function useHabits() {
  ...
  // Toggle a habit done/undone for today smoothly without batch sync lag
  function toggleHabit(id) {
    const key = todayKey()
    
    setCompletions(prevCompletions => {
      const todayList = prevCompletions[key] || []
      const alreadyDone = todayList.includes(id)
      
      const updatedTodayList = alreadyDone
